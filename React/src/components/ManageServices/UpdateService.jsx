...
const UpdateService = ({ onSuccess, service }) => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const { success } = await ServiceService.updateService(body)
    ...
    return (
        <>
            <button
                ...
                title="Sửa"
            >
                <Edit className="w-5 h-5 text-[#FF8800]" />
            </button>
            {
                open ? (
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="number"
                                                {...register('bookingAdvanceDays', { min: 0, max: 365 })}
                                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF8800] focus:border-transparent"
                                            />
                                        </div>
                                    </div>
